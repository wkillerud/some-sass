...
suite("CSS - Completion", () => {
	test("stylesheet", async function () {
		...
		await testCompletionFor("h| {", {
			items: [{ label: "html", resultText: "html {" }],
		});
	...
	test("selectors", async function () {
		...
		await testCompletionFor(".a { div:h| {} }", {
			items: [{ label: ":hover", resultText: ".a { div:hover {} }" }],
		});
	});
	test("properties", async function () {
		...
		await testCompletionFor("body { ver|", {
			items: [{ label: "vertical-align", resultText: "body { vertical-align: " }],
		});
		...
		await testCompletionFor("body { vertical-align|: bottom;}", {
			items: [{ label: "vertical-align", resultText: "body { vertical-align: bottom;}" }],
		});
		await testCompletionFor("body { trans| ", {
			items: [{ label: "transition", resultText: "body { transition:  " }],
		});
	});
	...
	test("values", async function () {
		...
		await testCompletionFor("body { vertical-align: bott|", {
			items: [{ label: "bottom", resultText: "body { vertical-align: bottom" }],
		});
		...
		await testCompletionFor("body { vertical-align: bottom; |}", {
			items: [{ label: "display", resultText: "body { vertical-align: bottom; display: }" }],
		});
		await testCompletionFor(".head { background-image: |}", {
			items: [{ label: "url()", resultText: ".head { background-image: url($1)}" }],
		});
		...
		await testCompletionFor(".foo { te:n| }", {
			items: [{ label: "n", notAvailable: true }],
		});
	});
	test("functions", async function () {
		await testCompletionFor("@keyframes fadeIn { 0% { transform: s|", {
			items: [
				{
					label: "scaleX()",
					resultText: "@keyframes fadeIn { 0% { transform: scaleX($1)",
	...
	test("units", async function () {
		await testCompletionFor("body { vertical-align: 9| }", {
			items: [{ label: "9cm", resultText: "body { vertical-align: 9cm }" }],
		});
		await testCompletionFor("body { vertical-align: 1.2| }", {
			items: [{ label: "1.2em", resultText: "body { vertical-align: 1.2em }" }],
		});
		await testCompletionFor("body { vertical-align: 1|0 }", {
			items: [{ label: "1cm", resultText: "body { vertical-align: 1cm }" }],
		});
		await testCompletionFor("body { vertical-align: 10c| }", {
			items: [{ label: "10cm", resultText: "body { vertical-align: 10cm }" }],
		});
		await testCompletionFor("body { top: -2px| }", {
			items: [{ label: "-2px", resultText: "body { top: -2px }" }],
		});
	});
	...
	test("colors", async function () {
		...
		await testCompletionFor("body { border-right: dotted 2em |", {
			items: [{ label: "cyan", resultText: "body { border-right: dotted 2em cyan" }],
		});
			...
			items: [
				{
					...
					resultText: ".foo { background-color: #123456; } .bar { background-color:#123456 }",
				},
			],
		});
		await testCompletionFor(".bar { background-color: #123| }", {
			items: [{ label: "#123", notAvailable: true }],
		});
			...
			items: [
				{
					...
					resultText: ".foo { background-color: rgb(${1:red}, ${2:green}, ${3:blue})",
				},
				{
					label: "rgba",
					kind: CompletionItemKind.Function,
					resultText: ".foo { background-color: rgba(${1:red}, ${2:green}, ${3:blue}, ${4:alpha})",
				},
				{
					label: "rgb relative",
					kind: CompletionItemKind.Function,
					resultText: ".foo { background-color: rgb(from ${1:color} ${2:r} ${3:g} ${4:b})",
				},
			...
			items: [
				{
					label: "--bg-color",
					documentation: "red",
					resultText: "a { color: var(--bg-color) } :root { --bg-color: red; } ",
				},
			],
		});
			...
			items: [
				{
					...
					resultText: "body { border-left: --borderwidth; border-right: var(--borderwidth ",
				},
			],
		});
		await testCompletionFor(
			"a { color: | } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
			{
				items: [
					{
						label: "--color-hex3",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-hex3) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
					{
						label: "--color-hex4",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-hex4) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
					{
						label: "--color-hex6",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-hex6) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
					{
						label: "--color-hex8",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-hex8) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
					{
						label: "--color-named",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-named) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
					{
						label: "--color-keyword",
						kind: CompletionItemKind.Color,
						resultText:
							"a { color: var(--color-keyword) } :root { --color-hex3: #f00; --color-hex4: #F007; --color-hex6: #ff0000; --color-hex8: #ff000077; --color-named: black; --color-keyword: currentColor; }",
					},
				],
			},
		);
		await testCompletionFor(
			"a { color: | } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
			{
				items: [
					{
						label: "--border-hex3",
						...
						resultText:
							"a { color: var(--border-hex3) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
					{
						label: "--border-hex4",
						kind: CompletionItemKind.Variable,
						resultText:
							"a { color: var(--border-hex4) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
					{
						label: "--border-hex6",
						kind: CompletionItemKind.Variable,
						resultText:
							"a { color: var(--border-hex6) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
					{
						label: "--border-hex8",
						kind: CompletionItemKind.Variable,
						resultText:
							"a { color: var(--border-hex8) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
					{
						label: "--border-named",
						kind: CompletionItemKind.Variable,
						resultText:
							"a { color: var(--border-named) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
					{
						label: "--border-keyword",
						kind: CompletionItemKind.Variable,
						resultText:
							"a { color: var(--border-keyword) } :root { --border-hex3: solid #f00 1px; --border-hex4: solid #F007 1px; --border-hex6: 1px #ff0000 solid; --border-hex8: #ff000077 #ff000077; --border-named: solid black 1px; --border-keyword: currentColor wavy; }",
					},
				],
			},
		);
			...
			items: [
				{
					label: "--color-rgb",
					kind: CompletionItemKind.Variable,
					resultText: "a { color: var(--color-rgb) } :root { --color-rgb: rgb(255 0 125 / 50%); }",
				},
			],
		});
			...
			items: [
				{
					label: "--border-rgb",
					kind: CompletionItemKind.Variable,
					resultText: "a { color: var(--border-rgb) } :root { --border-rgb: solid rgb(255 0 125 / 50%) 2px; }",
				},
			],
		});
	});
	test("support", async function () {
		...
		await testCompletionFor("@supports (| ) { }", {
			items: [{ label: "display", resultText: "@supports (display:  ) { }" }],
		});
		await testCompletionFor("@supports (di| ) { }", {
			items: [{ label: "display", resultText: "@supports (display:  ) { }" }],
		});
		await testCompletionFor("@supports (display: | ) { }", {
			items: [{ label: "flex", resultText: "@supports (display: flex ) { }" }],
		});
		await testCompletionFor("@supports (display: flex ) | { }", {
			items: [{ label: "display", notAvailable: true }],
		});
		await testCompletionFor("@supports |(display: flex ) { }", {
			items: [{ label: "display", notAvailable: true }],
		});
	...
	test("Property completeness", async () => {
		...
		await testCompletionFor(
			"body { disp| ",
			{
				items: [{ label: "display", resultText: "body { display: $0; ", command: undefined }],
			},
		...
		await testCompletionFor(
			"body { disp| ",
			{
				items: [{ label: "display", resultText: "body { display:  ", command: undefined }],
			},
	...
	test("CSS url() Path completion", async function () {
		...
		await testCompletionFor(
			...
			{
				items: [{ label: "about.html", resultText: 'html { background-image: url("./about.html")' }],
			},
			undefined,
			testUri,
			workspaceFolderUri,
		...
		await testCompletionFor(
			...
			{
				items: [{ label: "foo.asar", resultText: `html { background-image: url('../src/data/foo.asar')` }],
			},
			undefined,
			testUri,
			workspaceFolderUri,
	...
	test("CSS url() Path Completion - Unquoted url", async function () {
		...
		await testCompletionFor(
			...
			{
				items: [{ label: "about/", resultText: "html { background-image: url(../about/)" }],
			},
			undefined,
			testUri,
			workspaceFolderUri,
