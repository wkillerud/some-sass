...
- **deps:** update dependency es-toolkit to v1.44.0 ([#385](https://github.com/wkillerud/some-sass/pull/385))
- **deps:** update dependency es-toolkit to v1.43.0 ([#379](https://github.com/wkillerud/some-sass/pull/379))

### 🧱 Updated Dependencies

- Updated @somesass/vscode-css-languageservice to 2.2.8

## 2.3.7 (2025-12-12)

### 🩹 Fixes

- **deps:** update dependency es-toolkit to v1.42.0 ([#373](https://github.com/wkillerud/some-sass/pull/373))

### 🧱 Updated Dependencies

- Updated @somesass/vscode-css-languageservice to 2.2.7

## 2.3.6 (2025-11-11)

### 🩹 Fixes

- **deps:** update dependency es-toolkit to v1.41.0 ([#361](https://github.com/wkillerud/some-sass/pull/361))
...
- **deps:** update dependency es-toolkit to v1.39.10 ([#343](https://github.com/wkillerud/some-sass/pull/343))
...
- Updated @somesass/vscode-css-languageservice to 2.0.2
