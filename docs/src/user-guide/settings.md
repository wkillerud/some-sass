...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| `somesass.workspace.importAliases` | A map of aliases for file paths in the workspace, useful for example when using custom workspace tools to treat folders sort of as packages without publishing them. See [#346](https://github.com/wkillerud/some-sass/pull/346) for a usage example.                                                                                                                                                                | `{}`                                   |
