...
This document describes the settings available in Some Sass for Visual Studio Code. For the language server, see the [language server settings](../language-server/settings.md).
...
| `completion.css`                               | Enable or disable completions (IntelliSense) from the upstream VSCode CSS language services.                                                                                                                                       | `true`  |
