...
export const Rules = {
	AllVendorPrefixes: new Rule(
		...
		l10n.t("When using a vendor-specific prefix make sure to also include all other vendor-specific properties"),
		Ignore,
	),
	IncludeStandardPropertyWhenUsingVendorPrefix: new Rule(
		"vendorPrefix",
		l10n.t("When using a vendor-specific prefix also include the standard property"),
		Warning,
	),
	...
	RequiredPropertiesForFontFace: new Rule(
		"fontFaceProperties",
		l10n.t("@font-face rule must define 'src' and 'font-family' properties"),
		Warning,
	),
	HexColorLength: new Rule(
		"hexColorLength",
		l10n.t("Hex colors must consist of three, four, six or eight hex numbers"),
		Error,
	),
	...
	AvoidIdSelector: new Rule(
		"idSelector",
		l10n.t("Selectors should not contain IDs because these rules are too tightly coupled with the HTML."),
		Ignore,
	),
};
...
export const Settings = {
	ValidProperties: new Setting(
		"validProperties",
		l10n.t("A list of properties that are not validated against the `unknownProperties` rule."),
		[],
	),
};
