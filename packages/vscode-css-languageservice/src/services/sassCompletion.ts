...
export class SassCompletion extends CSSCompletion {
	...
	private static colorProposals: IFunctionInfo[] = [
		...
		},
		{
			...
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#adjust-hue).`,
		},
		{
			func: "lighten($color, $amount)",
			desc: l10n.t("Makes a color lighter."),
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#lighten).`,
		},
		{
			func: "darken($color, $amount)",
			desc: l10n.t("Makes a color darker."),
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#darken).`,
		},
		{
			func: "saturate($color, $amount)",
			desc: l10n.t("Makes a color more saturated."),
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#saturate).`,
		},
		{
			func: "desaturate($color, $amount)",
			desc: l10n.t("Makes a color less saturated."),
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#desaturate).`,
		},
		...
		{ func: "opacity($color)", desc: "Gets the alpha component (opacity) of a color." },
		{
			...
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#opacity).`,
		},
		{
		...
		},
		{
			...
			noModule: true,
			deprecated: `This function is deprecated in favor of color-space-friendly functions. See [the announcement post](https://sass-lang.com/blog/wide-gamut-colors-in-sass/#deprecated-functions), and [documentation for possible migration](https://sass-lang.com/documentation/modules/color/#transparentize).`,
		},
		{
	...
	private static selectorFuncs: IFunctionInfo[] = [
		{
			...
			desc: l10n.t("Nests selector beneath one another like they would be nested in the stylesheet."),
		},
		{
			func: "selector-append($selectors…)",
			desc: l10n.t("Appends selectors to one another without spaces in between."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Replaces $original with $replacement within $selector."),
		},
		{
			func: "selector-unify($selector1, $selector2)",
			desc: l10n.t("Unifies two selectors to produce a selector that matches elements matched by both."),
		},
		{
			func: "is-superselector($super, $sub)",
			desc: l10n.t("Returns whether $super matches all the elements $sub does, and possibly more."),
		},
		{
			func: "simple-selectors($selector)",
			desc: l10n.t("Returns the simple selectors that comprise a compound selector."),
		},
	...
	private static builtInFuncs: IFunctionInfo[] = [
		...
		{ func: "str-insert($string, $insert, $index)", desc: l10n.t("Inserts $insert into $string at $index.") },
		{
			...
			desc: l10n.t("Returns the index of the first occurance of $substring in $string."),
		},
		...
		{
			func: "keywords($args)",
			desc: l10n.t("Returns the keywords passed to a function that takes variable arguments."),
		},
		{ func: "feature-exists($feature)", desc: l10n.t("Returns whether a feature exists in the current Sass runtime.") },
		{
			...
			desc: l10n.t("Returns whether a variable with the given name exists in the current scope."),
		},
		{
			func: "global-variable-exists($name)",
			desc: l10n.t("Returns whether a variable with the given name exists in the global scope."),
		},
		...
		{
			func: "inspect($value)",
			desc: l10n.t("Returns the string representation of a value as it would be represented in Sass."),
		},
		...
		{ func: "unitless($number)", desc: l10n.t("Returns whether a number has units.") },
		{
			...
			desc: l10n.t("Returns whether two numbers can be added, subtracted, or compared."),
		},
